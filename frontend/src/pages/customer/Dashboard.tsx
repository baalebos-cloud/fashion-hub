  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center justify-between">
        ...
        <Link to={customerRoutes.findProfessionals}><Button>Find a professional</Button></Link>
      </div>
      ...
      <div>
        ...
        {!isLoading && <OrderList orders={orders.slice(0, 5)} detailsPathFor={customerRoutes.orderDetails} />}
      </div>
    </div>
  );
}
